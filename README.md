...
スタミナは トロフィーの左。カウンター(🏆⭐)より 大きい文字のまま。
音の切りかえ(🔊)は 場所を作るため **☰メニューの中**に移してある。
...
| `StaminaRow` | ヘッダーの⚡。トロフィーの左。数・ゲージ・のこり時間 |
...
375px は かなり きつい。**見出し(19px)と ⚡スタミナ(19/15px)は 削らない**
と決めてあり、そのぶん カウンター(🏆⭐)を 小さく(15/11px)し、
🔊は メニューへ 追い出してある。ここに何か足すなら
削るのは カウンター側から。
